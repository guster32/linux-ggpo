...
typedef struct {
    ...
    */
   bool (GGPO_API *begin_game)(const char *game);
    ...
    */
   bool (GGPO_API *save_game_state)(unsigned char **buffer, int *len, int *checksum, int frame);
    ...
    * buffer.
    */
   bool (GGPO_API *load_game_state)(unsigned char *buffer, int len);
    ...
    */
   bool (GGPO_API *log_game_state)(char *filename, unsigned char *buffer, int len);

   /*
    * free_buffer - Frees a game state allocated in save_game_state.  You
    * should deallocate the memory contained in the buffer.
    */
   void (GGPO_API *free_buffer)(void *buffer);
    ...
    */
   bool (GGPO_API *advance_frame)(int flags);

   /*
    * on_event - Notification that something has happened.  See the GGPOEventCode
    * structure above for more information.
    */
   bool (GGPO_API *on_event)(GGPOEvent *info);
