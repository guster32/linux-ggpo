...
GGPOErrorCode ggpo_add_player(GGPOSession *ggpo,
                              GGPOPlayer *player,
...
GGPOErrorCode ggpo_set_frame_delay(GGPOSession *ggpo,
...
GGPOErrorCode ggpo_add_local_input(GGPOSession *ggpo,
                                   GGPOPlayerHandle player,
                                   void *values,
                                   int size)
{
...
GGPOErrorCode ggpo_get_network_stats(GGPOSession *ggpo,
                                     GGPOPlayerHandle player,
